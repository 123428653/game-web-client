...
function(e) {
	...
	s.m = e, s.c = a, s.d = function(e, t, i) {
		...
		if (s.r(i), Object.defineProperty(i, "default", {
			enumerable: !0,
			value: e
		}), 2 & t && "string" != typeof e) for (var a in e) s.d(i, a, function(t) {
			return e[t]
		}.bind(null, a));
		return i
	}, s.n = function(e) {
			...
			i = new window.Swiper("#J-page", {
				...
				on: {
					slideChangeTransitionStart: function() {
						...
						0 === e ? $(".nav-top .logo").hide() : $(".nav-top .logo").show(), $(".nav-top").hide()
					},
				...
				function() {
					...
					var e = $(this).data("mp4"),
						t = '<iframe src="https://www.youtube.com/embed/' + e + '?autoplay=1" frameborder="0" allowfullscreen=""></iframe>';
				...
				}), "inven" === a.util.getUrlParams(window.location.href).from && nie.config.stats.url.add(window.location.host + window.location.pathname + "?action=inven-pc", "inven PC")
			}, 100)
		})
	},
	bQYj: function(e, t, i) {},
	...
	nt4k: function(e, t, i) {
		...
		Object.defineProperty(t, "__esModule", {
			...
			a(n), $(".news-wrap").delegate(".page-btn", "click", function() {
				...
				var e = $(this).index();
				$(".slide-news .tab-wrap .tab-item").removeClass("tab-active"), $(".slide-news .tab-wrap .tab-item").eq(e).addClass("tab-active"), 0 === e ? a(n) : 1 === e ? a(o) : 2 === e && a(s)
			})
		};
		var a = window.location.origin,
			n = a + "/inline/20v1/news/index.html",
			o = a + "/inline/20v1/update/index.html",
			s = a + "/inline/20v1/official/index.html"
	},
	qdpH: function(e, t, i) {
		"use strict";
		Object.defineProperty(t, "__esModule", {
		...
		var a = i("EHqQ"),
			n = a.arms.tabArray,
			o = a.arms.weapon.weaponIntroArray,
			s = a.arms.weapon.labels,
			p = a.arms.corps.corpsLabelArray,
			l = a.arms.corps.corpsArray,
			r = a.arms.corps.corpsTabArray,
			d = a.arms.apparatusArray,
			c = -138 * Math.PI / 180,
			m = {
				init: function() {
					new window.Swiper("#J-arms", {
						...
						for (var e = "", t = l, i = 0, a = t.length; i < a; i++) {
							for (var n = t[i].group, o = "", s = 0, d = n.length; s < d; s++) {
								...
								var h = "";
								0 === s && (h = "corps-intro-show"), o += ' <div class="intro-wrap corps-intro-' + (s + 1) + " " + h + '">\n                            <div class="title-wrap">\n                                <span class="title">' + v.title + '</span>                         \n                            </div>\n                            <div class="intro">\n                                <div class="intro-left">\n                                    ' + c + '\n                                </div>\n                                 <div class="intro-right">\n                                    ' + m + "\n                                </div>\n                            </div>\n                        </div>"
							}
						...
						$("#J-apparatus").find(".swiper-wrapper").html(e), new window.Swiper("#J-apparatus", {
							...
							on: {
								...
								slidePrevTransitionStart: function() {
									var e = this.activeIndex;
									6 === e && $("#J-pagination-apparatus").css("transform", "rotate(0deg)")
								},
								slideNextTransitionStart: function() {
									var e = this.activeIndex;
									7 === e && $("#J-pagination-apparatus").css("transform", "rotate(-112deg)")
								},
								slideChangeTransitionStart: function() {
						...
						var e = $(this).attr("data-thumb"),
							t = $(this).closest(".kv-wrap").find(".kv"),
							i = t.attr("data-kv"),
							a = t.data("name" + i);
	...
	[5],
	{
		"7ibs": function(i, e, g) {
			...
			var f = Object.freeze({
				...
				throttle: function(i) {
					var e, t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 300,
						g = new Date;
					return function() {
						var f = arguments,
							n = new Date;
				...
				scaleImage: function(i, e, t, g, f, n) {
					var o = new RegExp("^(http://|https://|//)nos.netease.com/"),
						r = new RegExp("nosdn.127.net"),
						a = new RegExp("^data:image/"),
						s = "";
					...
					return i && !a.test(i) && u(i) ? (s = i = i.replace(/^(http:|https:)/, ""), (e || t || g) && (r.test(s) || o.test(s)) && (s = function(i, e, t, g) {
						var n, o, r, a = "";
						if (e && t && (a = "&thumbnail=" + e + (f || "y") + t), o = (i.split("?") || [])[0], (n = i.split("?")[1] || "") && -1 == n.indexOf("imageView")) o = i + (n ? "&" : "?") + "imageView" + a + "&quality=100";
						else {
							r = n ? n.split("&") : [];
							for (var s = 0; s < r.length; s++) - 1 == r[s].indexOf("thumbnail") && -1 == r[s].indexOf("imageView") && -1 == r[s].indexOf("quality") || (r.splice(s, 1), s -= 1);
							o = o + "?imageView&quality=100" + (r.length > 0 ? "&" + r.join("&") : "") + a
						}
						return g && (o += "&" + g), o
					}(s, e, t, g)), n && (s = function(i) {
						var e, t;
						return u(i) ? (t = i.substring(i.lastIndexOf(".")), e = new RegExp(/^\.gif/), !
						function() {
							var i;
							try {
						...
						}() || e.test(t) ? i : -1 != i.indexOf("imageView") ? i + "&type=webp" : i + "imageView&type=webp") : i
					}(s)), s) : i
				}
			}),
				n = Object.freeze({
					...
					orientation: function(i) {
						...
						90 !== window.orientation && -90 !== window.orientation || e.show(), $(window).bind("orientationchange", function() {
							return 0 === window.orientation || 180 === window.orientation ? (e.hide(), !1) : 90 === window.orientation || -90 === window.orientation ? (e.show(), !1) : void 0
						})
					},
					trueload: function(i) {
						var e = i.imgList,
							t = i.customAnimation,
							g = i.completeCallback;
					...
					detectBrowser: function() {
						var i, e, g = window.navigator.userAgent.toLowerCase(),
							f = r(/version\/(\d+(\.\d+)?)/i),
							n = r(/edge\/(\d+(\.\d+)?)/i),
							o = (!/tablet/i.test(g) && /[^-]mobi/i.test(g), {});
						...
						g > 0 ? (t = g / e * 625, t += "%", $("html").css("font-size", t)) : (function() {
							...
							window.requestAnimationFrame || (window.requestAnimationFrame = function(e, t) {
								var g = (new Date).getTime(),
									f = Math.max(0, 16.7 - (g - i)),
									n = window.setTimeout(function() {
										"function" == typeof e && e(g + f)
									}, f);
								return i = g + f, n
